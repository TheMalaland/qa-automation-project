...
exports.AllureMochaReporter = void 0;
...
var _MochaTestRuntime = require("./MochaTestRuntime.js");
var _extraReporters2 = require("./extraReporters.js");
var _legacyUtils = require("./legacyUtils.js");
var _utils = require("./utils.js");
var _excluded = ["resultsDir", "extraReporters"];
...
var _extraReporters = /*#__PURE__*/new WeakMap();
class AllureMochaReporter extends Mocha.reporters.Base {
  constructor(runner, _opts) {
    var _this, _opts$reporterOptions;
    ...
    _classPrivateFieldInitSpec(this, _extraReporters, []);
    ...
    _defineProperty(this, "onSuite", suite => {
      if (!suite.parent && this.testplan) {
        (0, _utils.applyTestPlan)(this.testplan.idIndex, this.testplan.fullNameIndex, suite);
      }
    ...
    _defineProperty(this, "onTest", test => {
      if (this.currentTest) {
        ...
        if (retriedTest) {
          ...
          var testScope = (0, _utils.getTestScope)(retriedTest);
          if (testScope) {
      ...
      var globalLabels = (0, _reporter.getEnvironmentLabels)().filter(label => !!label.value);
      var initialLabels = [(0, _reporter.getLanguageLabel)(), (0, _reporter.getFrameworkLabel)(this.getFrameworkName()), (0, _reporter.getHostLabel)(), (0, _reporter.getThreadLabel)(this.getWorkerId())];
      var metaLabels = (0, _utils.getAllureMetaLabels)(test);
      var labels = globalLabels.concat(initialLabels, metaLabels);
      if (test.file) {
        var packageLabel = (0, _reporter.getPackageLabel)(test.file);
      ...
      this.currentTest = this.runtime.startTest({
        name: (0, _utils.getAllureDisplayName)(test),
        stage: _allureJsCommons.Stage.RUNNING,
        fullName: (0, _utils.getAllureFullName)(test),
        labels,
    ...
    _defineProperty(this, "onFailed", (_, error) => {
      ...
      this.runtime.updateTest(this.currentTest, r => {
        r.status = (0, _sdk.getStatusFromError)(error);
    ...
    _defineProperty(this, "onPending", test => {
      if ((0, _utils.isIncludedInTestRun)(test)) {
        if (!this.currentTest) {
          this.onTest(test);
        }
        this.runtime.updateTest(this.currentTest, r => {
          r.status = _allureJsCommons.Status.SKIPPED;
          r.statusDetails = {
    ...
    _defineProperty(this, "onTestEnd", test => {
      ...
      if ((0, _utils.isIncludedInTestRun)(test)) {
        var defaultSuites = (0, _utils.getSuitesOfMochaTest)(test);
        this.runtime.updateTest(this.currentTest, t => {
          (0, _reporter.ensureSuiteLabels)(t, defaultSuites);
          t.stage = _allureJsCommons.Stage.FINISHED;
        });
    ...
    _defineProperty(this, "getWorkerId", () => _nodeProcess.env.MOCHA_WORKER_ID);
    var allureConfig = (_opts$reporterOptions = _opts.reporterOptions) !== null && _opts$reporterOptions !== void 0 ? _opts$reporterOptions : {};
    var {
        resultsDir,
        extraReporters
      } = allureConfig,
      restOptions = _objectWithoutProperties(allureConfig, _excluded);
    this.isInWorker = isInWorker;
    this.runtime = new _reporter.ReporterRuntime(_objectSpread({
      writer: (0, _reporter.createDefaultWriter)({
        resultsDir
      })
    }, restOptions));
    this.testplan = (0, _utils.createTestPlanIndices)();
    var testRuntime = new _MochaTestRuntime.MochaTestRuntime(this.applyRuntimeMessages);
    (0, _runtime.setGlobalTestRuntime)(testRuntime);
    (0, _legacyUtils.setLegacyApiRuntime)(this);
    if (_opts.parallel) {
      var _opts$require;
      _opts.require = [...((_opts$require = _opts.require) !== null && _opts$require !== void 0 ? _opts$require : []), (0, _utils.resolveParallelModeSetupFile)()];
    } else {
      this.applyListeners();
    }
    if (!isInWorker && extraReporters) {
      _classPrivateFieldSet(_extraReporters, this, (0, _extraReporters2.enableExtraReporters)(runner, _opts, extraReporters));
    }
  }
  done(failures, fn) {
    this.runtime.writeEnvironmentInfo();
    this.runtime.writeCategoriesDefinitions();
    (0, _extraReporters2.doneAll)(_classPrivateFieldGet(_extraReporters, this), failures, fn);
  }
}
exports.AllureMochaReporter = AllureMochaReporter;
